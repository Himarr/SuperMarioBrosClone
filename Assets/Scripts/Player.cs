...
public class Player : MonoBehaviour
{
    ...
    {
        /* 
            Se encarga del Input y los c�lculos de velocidad y aceleraci�n de Mario.
        */
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            onHit();
            //Tambi�n haz que caiga hacia abajo, con el cambio de capa ya puede atravesar el suelo al morir, que yo no se hacerlo ahora
        }
    }
    ...
    {
        // Corrutina que maneja los cambios en el collider durante la animaci�n de PowerUp.
